...
if __name__ == "__main__":
    ...
    plt.figure()
    plt.plot(get_row(red, 200))
    plt.plot(get_row(red, 400))
    plt.plot(get_row(red, 600))
    plt.plot(get_row(red, 800))
    plt.plot(get_row(red, 1000))
    plt.xlabel("pixel [-]")
    plt.ylabel("value [-]")
    plt.legend(["px 200", "px 400", "px 600", "px 800", "px 1000"])
    plt.show(block=False)
    ...
    plt.figure()
    plt.plot(get_row(nir, 200))
    plt.plot(get_row(nir, 400))
    plt.plot(get_row(nir, 600))
    plt.plot(get_row(nir, 800))
    plt.plot(get_row(nir, 1000))
    plt.xlabel("pixel [-]")
    plt.ylabel("value [-]")
    plt.legend(["px 200", "px 400", "px 600", "px 800", "px 1000"])
    plt.show()
